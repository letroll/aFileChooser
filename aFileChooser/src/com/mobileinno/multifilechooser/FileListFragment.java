...
public class FileListFragment extends ListFragment implements
    ...
    private View.OnClickListener btnSelectedOnClick;
	...
	btnSelectedOnClick = new View.OnClickListener() {

	    public void onClick(View v) {
		((FileChooserActivity) getActivity()).onDecisionMade(mAdapter.getSelectedFiles());
	    }
	};
	...
	btnSelected = (Button) getActivity().findViewById(R.id.footer);
	btnSelected.setOnClickListener(btnSelectedOnClick);
